    ...
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h4>Persyaratan Inpassing Guru</h4>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ asset('/dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Inpassing Guru</a></li>
            </ol>
        </div>
    </div>
    {{-- End --}}
        ...
        <div class="col-xl-8 col-lg-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tabel Pesyaratan Inpassing Guru</h4>
                        ...
                        <div class="card-body">
                            <form id="form_syarat" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="jenis" name="jenis" value="inpassing">
